...
class Inventory(object):
    def __init__(self,Login):
        ...
        self.items = []
    def getInventory(self,steamID,appID,contextID):
        response = self.request.get("https://steamcommunity.com/id/" + steamID + "/inventory/json/" + str(appID) + "/" + str(contextID))
        ...
        for x in rgInventory.keys():
            ...
            self.items.append(Item(item_id,class_id,instance_id,amount,description))

class Item(object):
    def __init__(self,item_id,class_id,instance_id,amount,description):
        self.itemid = item_id
